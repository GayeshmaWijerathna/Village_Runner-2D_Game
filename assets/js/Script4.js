...
var backgroundm = new Audio("resources/audio/the-jungle.wav");
...
function moveBackground() {
    ...
    document.getElementById("background4").style.backgroundPositionX = backgroundImagePositionX + "px";
...
function createBoxes(){
    ...
    box.className = "box";
    document.getElementById("background4").appendChild(box);
